...
<body>
     <section class="hero">
        ...
        <div class="section-container">
            <div class="columns image" style="background-image:url('../imgs/info1.jpg')">
              &nbsp;
            </div>
         ...
         <div class="section-container">
           ...
           <div class="columns image" style="background-image:url('../imgs/info2.jpg')">
               &nbsp;
            </div>
       </div>

         <div class="section-container">
            <div class="columns image" style="background-image:url('../imgs/info3.jpg')">
               &nbsp;
            </div>
       ...
       <div class="section-container">
          <div class="columns content">
            ...
            <div class="columns image" style="background-image:url('../imgs/info4.jpg')">
               &nbsp;
            </div>
        </div>
